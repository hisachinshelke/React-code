...
const {resData} = props;
  ...
  return (
    <div className="rest-card">
      ...
      src=
      {"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/" + resData.info.cloudinaryImageId}
      />
  ...
  return (
    <div className="body">
      ...
      <div className="rest-container">
          ...
          <RestaurantCard resData = {restDataList[1]}/>
          <RestaurantCard resData = {restDataList[2]}/>
          <RestaurantCard resData = {restDataList[3]}/>
          <RestaurantCard resData = {restDataList[4]}/>
          <RestaurantCard resData = {restDataList[5]}/>
